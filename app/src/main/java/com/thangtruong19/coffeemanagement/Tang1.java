...
public class Tang1 extends AppCompatActivity {
    ...
    private void truyenban(Intent intent, String key, String value) {
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if ((requestCode == 101) && (resultCode == Activity.RESULT_OK)) {
            ...
            if (nhanhienthi.equals("1")) {
                lblban1.setBackgroundResource(R.color.colorPrimaryDark);
            }
        }
        ...
        if ((requestCode == 102) && (resultCode == Activity.RESULT_OK)) {
            ...
            if (nhanhienthi.equals("2")) {
                lblban2.setBackgroundResource(R.color.colorPrimaryDark);
            }
        }
        ...
        if ((requestCode == 103) && (resultCode == Activity.RESULT_OK)) {
            ...
            if (nhanhienthi.equals("3")) {
                lblban3.setBackgroundResource(R.color.colorPrimaryDark);
            }
        }
        ...
        if ((requestCode == 104) && (resultCode == Activity.RESULT_OK)) {
            ...
            if (nhanhienthi.equals("4")) {
                lblban4.setBackgroundResource(R.color.colorPrimaryDark);
            }
        }
        ...
        if ((requestCode == 105) && (resultCode == Activity.RESULT_OK)) {
            ...
            if (nhanhienthi.equals("5")) {
                lblban5.setBackgroundResource(R.color.colorPrimaryDark);
            }
        }
        ...
        if ((requestCode == 106) && (resultCode == Activity.RESULT_OK)) {
            ...
            if (nhanhienthi.equals("6")) {
                lblban6.setBackgroundResource(R.color.colorPrimaryDark);
            }
        }
        ...
        if ((requestCode == 107) && (resultCode == Activity.RESULT_OK)) {
            ...
            if (nhanhienthi.equals("7")) {
                lblban7.setBackgroundResource(R.color.colorPrimaryDark);
            }
        }
        ...
        if ((requestCode == 108) && (resultCode == Activity.RESULT_OK)) {
            ...
            if (nhanhienthi.equals("8")) {
                lblban8.setBackgroundResource(R.color.colorPrimaryDark);
            }
        }
        ...
        if ((requestCode == 109) && (resultCode == Activity.RESULT_OK)) {
            ...
            if (nhanhienthi.equals("9")) {
                lblban9.setBackgroundResource(R.color.colorPrimaryDark);
            }
        }
        ...
        if ((requestCode == 110) && (resultCode == Activity.RESULT_OK)) {
            ...
            if (nhanhienthi.equals("10")) {
                lblban10.setBackgroundResource(R.color.colorPrimaryDark);
            }
        }
        ...
        if ((requestCode == 111) && (resultCode == Activity.RESULT_OK)) {
            ...
            if (nhanhienthi.equals("11")) {
                lblban11.setBackgroundResource(R.color.colorPrimaryDark);
            }
        }
        ...
        if ((requestCode == 112) && (resultCode == Activity.RESULT_OK)) {
            ...
            if (nhanhienthi.equals("12")) {
                lblban12.setBackgroundResource(R.color.colorPrimaryDark);
            }
        }
    }
