...
public class ChonThucUong extends AppCompatActivity implements OnItemSelectedListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            dbs = SQLiteDatabase.openDatabase("/data/data/com.thangtruong19.coffeemanagement/order", null,
                    SQLiteDatabase.CREATE_IF_NECESSARY);
            Toast.makeText(this, "Đã Tạo Thành Công Cơ Sở Dữ Liệu", Toast.LENGTH_SHORT).show();
            flag = true;
        ...
        try {
            if (c == true) {
                Toast.makeText(this, "Bảng dữ liệu đã được tạo,mời bạn order thông tin", Toast.LENGTH_SHORT).show();
            }
            if (c == false) {
                ...
                Toast.makeText(this, "Đã tạo bảng danh sách order", Toast.LENGTH_SHORT).show();
                c = true;
            }
        } catch (SQLException e) {
            // TODO: handle exception
        ...
        btnorder.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                guitinnhan(sodienthoai, noidungorder);
    ...
    private void guitinnhan(String numberphone, String content) {
    ...
    public void prepare(String tb) {
        ...
        Toast.makeText(getApplicationContext(), tb + " order thành công", Toast.LENGTH_SHORT).show();
    }
